...
void calculateSquareProperties() {
    ...
    if (calculationChoice == 1) {
        ...
        cout<<"\n\t\t\t\t\tThe perimeter of the square is: " << perimeter << endl;
    } else {
        cout<<"\t\t\t\t\tInvalid choice!" << endl;
    }
}
...
if(Choice==2){
    ...
    cout << "\n\t\t\t\t\tThe Peremeter of the triangle is: " << peremeter << endl;
}
}
...
if(Choice==2){
    ...
    cout << "\n\t\t\t\t\tThe Peremeter of the Rectangle is: " << peremeter << endl;
}
}
...
if(Choice==2){
    ...
    cout << "\n\t\t\t\t\tThe Peremeter of the Parallelogram is: " << peremeter << endl;
}
}
...
if(Choice==2){
    ...
    cout << "\n\t\t\t\t\tThe Peremeter of the Trapezoid is: " << peremeter << endl;
}   
}
...
if(Choice==2){
    ...
    cout << "\n\t\t\t\t\tThe Peremeter of the Hexagon is: " << peremeter << endl;
}   
}
//                       3D   SHAPES         //
...
void calculateSphereProperties() {
    ...
    cin >> radius;
        ...
        cout << "\n\t\t\t\t\tThe surface area of the sphere is: " <<surfaceArea<<endl;
...
void calculateCubeProperties() {
    ...
    cin >> side;
        ...
        cout << "\n\t\t\t\t\tThe surface area of the Cube is: " <<surfaceArea<<endl;
...
void calculateCylinderProperties() {
    ...
    cout << "\n\t\t\t\t\tThe surface area of the cylinder is: "<<surfaceArea<<endl;
...
void calculateConeProperties() {
    ...
    cout<<"\n\t\t\t\t\tThe surface area of the cone is: " << surfaceArea << endl;
}
   else  if (calculationChoice == 2) {
    ...
    // Display the result
    cout<<"\n\t\t\t\t\tThe surface area of the cuboid is: " << surfaceArea << endl;
}
   else  if (calculationChoice == 2) {
   ...
   void calculatePyramidProperties() {
    ...
    // Display the result
    cout << "\n\t\t\t\t\tThe surface area of the pyramid is: " << surfaceArea << endl;
}
      else  if (calculationChoice == 2) {
 ...
 void calculatePrismProperties() {
    ...
    // Display the result
    cout << "\n\t\t\t\t\tThe surface area of the prism is: " << surfaceArea << endl;
}
   else  if (calculationChoice == 2) {
    	 double length, width, height;
    ...
    // Display the result
    cout << "\n\t\t\t\t\tThe volume of the prism is: " << volume << endl;
}
}
int main() {
	system("CLS");
